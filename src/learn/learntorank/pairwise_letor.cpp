 ...
 * @param model
 */
void pairwise_letor::train(string data_dir, int feature_nums, sgd_model *model) {
 ...
 * @param dataset_nodes
 */
void pairwise_letor::build_dataset_nodes(unordered_map<string, unordered_map<int, vector<feature_vector>>> *training_dataset,
 ...
 * @return
 */
std::pair<pairwise_letor::tupl, pairwise_letor::tupl> pairwise_letor::getRandomPair(vector<string> *training_qids,
                                    unordered_map<string, unordered_map<int, vector<feature_vector>>> *training_dataset,
                                    int random_seed) {
 ...
 * @return
 */
svm_wrapper *pairwise_letor::train_svm(string data_dir, int feature_nums, string svm_path) {
    vector<string> *training_qids = new vector<string>();
