...
namespace ranker
{
     ...
     * @param model
     */
    void let::train(string data_dir, int feature_nums, sgd_model *model) {
    ...
    * @param feature_nums
    */
    void let::read_data(DATA_TYPE data_type,
                        string data_dir,
                        vector<string> *qids,
     ...
     * @param dataset_nodes
     */
    void let::build_dataset_nodes(unordered_map<string, unordered_map<int, vector<feature_vector>>> *training_dataset,
     ...
     * @return
     */
    std::pair<let::tupl, let::tupl> let::getRandomPair(vector<string> *training_qids,
                                        unordered_map<string, unordered_map<int, vector<feature_vector>>> *training_dataset,
                                        int random_seed) {
     ...
     * @return
     */
    svm_wrapper *let::train_svm(string data_dir, int feature_nums, string svm_path) {
        vector<string> *training_qids = new vector<string>();
     ...
     * @param model
     */
    void let::validate(string data_dir,
                       int feature_nums,
    ...
    * @param model
    */
    void let::test(string data_dir, int feature_nums, CLASSIFY_TYPE classify_type, svm_wrapper *wrapper, sgd_model *model) {
        ...
        evaluate(testing_qids, testing_dataset, testing_docids, relevance_map, feature_nums, classify_type, wrapper,
                 model);
     ...
     * @param model
     */
    void let::evaluate(vector<string> *qids,
                  unordered_map<string, unordered_map<int, vector<feature_vector>>> *dataset,
                  unordered_map<string, unordered_map<int, vector<string>>> *docids,
                  unordered_map<string, unordered_map<string, int>> *relevance_map,
                  int feature_nums,
     ...
     * @return
     */
    double let::compute_dcg(int limit, vector<int> &rankings) {
        double dcg = 0, dg;
