...
#ifndef META_NGRAM_LEX_ANALYZER_H_
#define META_NGRAM_LEX_ANALYZER_H_
...
class ngram_lex_analyzer : public util::multilevel_clonable
                           <analyzer, ngram_simple_analyzer, ngram_lex_analyzer>
{
