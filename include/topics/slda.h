...
class slda
{
    public:
         ...
         */
        void estimate(const std::vector<corpus::document> & docs);
         ...
         */
        void infer(const std::vector<corpus::document> & docs);
    ...
    private:
         ...
         */
        size_t create_input_files(const std::vector<corpus::document> & docs);
